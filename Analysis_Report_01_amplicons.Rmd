...
With human DNA, it is highly conventional (and easy) to determine biological gender based on chromosomal signatures. Is it then possible that our microbiomes carry a gender signature as well, since they are so intrinsicly tied to us? 
...
plot_bar(subset_male_obj, fill = "Phylum")
```
